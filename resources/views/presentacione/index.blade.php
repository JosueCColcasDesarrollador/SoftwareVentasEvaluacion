...
<div class="container-fluid px-4">
    ...
    <div class="mb-4">
        <a href="{{route('presentaciones.create')}}">
            <button type="button" class="btn btn-primary">Añadir Presentaciones</button>
        </a>
    </div>
    @endcan
                            ...
                            <div class="d-flex justify-content-around">
                                <div>
                                    ...
                                    <ul class="dropdown-menu text-bg-light" style="font-size: small;">
                                        ...
                                        <li><a class="dropdown-item" href="{{route('presentaciones.edit',['presentacione'=>$item])}}">Modificar</a></li>
                                        @endcan
                                    </ul>
                                </div>
                                <div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    {{ $item->caracteristica->estado == 1 ? '¿Quieres proceder con la eliminación de la presentación?' : '¿Quieres proceder con la restauración de la presentación?' }}
                                </div>

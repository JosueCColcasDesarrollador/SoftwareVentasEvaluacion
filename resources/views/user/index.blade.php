...
<div class="container-fluid px-4">
    ...
    <div class="mb-4">
        <a href="{{route('users.create')}}">
            <button type="button" class="btn btn-primary">Añadir Usuarios</button>
        </a>
    </div>
    @endcan
                            ...
                            <div class="d-flex justify-content-around">
                                <div>
                                    ...
                                    <ul class="dropdown-menu text-bg-light" style="font-size: small;">
                                        <!-----Editar usuarios--->
                                        @can('editar-user')
                                        <li><a class="dropdown-item" href="{{route('users.edit',['user'=>$item])}}">Modificar</a></li>
                                        @endcan
                                    </ul>
                                </div>
                                <div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ¿Seguro que deseas eliminar el Usuario permanentemente?
                                </div>

...
<div class="container-fluid px-4">
    ...
    <div class="mb-4">
        <a href="{{route('marcas.create')}}">
            <button type="button" class="btn btn-primary">AÑADIR MARCAS</button>
        </a>
    </div>
    @endcan
                            ...
                            <div class="d-flex justify-content-around">
                                ...
                                <div>
                                    ...
                                    <ul class="dropdown-menu text-bg-light" style="font-size: small;">
                                        <!-----Editar marca--->
                                        @can('editar-marca')
                                        <li><a class="dropdown-item" href="{{route('marcas.edit',['marca'=>$item])}}">Modificar</a></li>
                                        @endcan
                                    </ul>
                                </div>
                                <div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    {{ $item->caracteristica->estado == 1 ? '¿Quieres proceder con la eliminación de la marca?' : '¿Quieres proceder con la restauración de la marca?' }}
                                </div>

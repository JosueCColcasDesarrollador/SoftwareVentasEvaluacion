    ...
    <div class="btn-group" role="group">
        ...
        <div class="mb-4">
            <a href="{{route('productos.create')}}">
                <button type="button" class="btn btn-primary">Añadir Productos</button>
            </a>
        </div>
        @endcan
                            ...
                            <div class="d-flex justify-content-around">
                                <div>
                                    ...
                                    <ul class="dropdown-menu text-bg-light" style="font-size: small;">
                                        <!-----Editar Producto--->
                                        @can('editar-producto')
                                        <li><a class="dropdown-item" href="{{route('productos.edit',['producto' => $item])}}">Modificar</a></li>
                                        @endcan
                                        <!----Ver-producto--->
                                        @can('ver-producto')
                                        <li>
                    ...
                    <div class="modal fade" id="confirmModal-{{$item->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    {{ $item->estado == 1 ? '¿Quieres proceder con la eliminación del producto?' : '¿Quieres proceder con la restauración del producto?' }}
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>

...
<div class="container-fluid px-4">
    ...
    <div class="mb-4">
        <a href="{{route('proveedores.create')}}">
            <button type="button" class="btn btn-primary">Añadir Proveedores</button>
        </a>
    </div>
    @endcan
            ...
            <table id="datatablesSimple" class="table table-striped fs-6">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <p class="text-muted mb-0">{{$item->persona->documento->tipo_documento}}</p>
                        </td>
                        <td>
                            ...
                            <div class="d-flex justify-content-around">
                                ...
                                <div>
                                    ...
                                    <ul class="dropdown-menu text-bg-light" style="font-size: small;">
                                        ...
                                        <li><a class="dropdown-item" href="{{route('proveedores.edit',['proveedore'=>$item])}}">Modificar</a></li>
                                        @endcan
                                    </ul>
                                </div>
                                <div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    {{ $item->persona->estado == 1 ? '¿Quieres proceder con la eliminación del proveedor?' : '¿Quieres proceder con la restauración del proveedor?' }}
                                </div>

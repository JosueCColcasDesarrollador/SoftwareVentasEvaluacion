...
<div class="container-fluid px-4">
    ...
    <div class="mb-4">
        <a href="{{route('clientes.create')}}">
            <button type="button" class="btn btn-primary">Añadir Clientes</button>
        </a>
    </div>
    @endcan
                            ...
                            <div class="d-flex justify-content-around">
                                ...
                                <div>
                                    ...
                                    <ul class="dropdown-menu text-bg-light" style="font-size: small;">
                                        <!-----Editar cliente--->
                                        @can('editar-cliente')
                                        <li><a class="dropdown-item" href="{{route('clientes.edit',['cliente'=>$item])}}">Modificar</a></li>
                                        @endcan
                                    </ul>
                                </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    {{ $item->persona->estado == 1 ? '¿Quieres proceder con la eliminación del cliente?' : '¿Quieres proceder con la restauración del cliente?' }}
                                </div>
